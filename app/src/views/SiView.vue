<template>
    <div>
      <h1 class="text-3xl font-bold underline">Hate Crimes by category on Staten Island</h1>
      <RouterLink to="/"><button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">Back to Home</button></RouterLink>
